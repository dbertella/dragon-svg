...
let DragonComponent = React.createClass({
	...
	render: function () {
		...
		return (
			<g>
				<path id={ dragons[this.props.randomDragonNumber].name } className={this.state.classToFly} fill="none" stroke="#A8240B" strokeWidth="8" strokeLinecap="round" stroke-miterlimit="10" d={dragons[this.props.randomDragonNumber].path} />
				<path id={ dragons[this.props.randomDragonNumber].name + '-scia'} className={this.state.classToFly} fill="none" stroke="#86FCFF" strokeWidth="15" strokeLinecap="round" stroke-miterlimit="10" d={dragons[this.props.randomDragonNumber].path} />
			</g>
		);
		// return (
		...
		// 		return (
		// 			<g>
		// 				<path id={ d.name } className={this.state.flyingClass} fill="none" stroke="#A8240B" strokeWidth="8" strokeLinecap="round" stroke-miterlimit="10" d={d.path} />
		// 				<path id={ d.name + '-scia'} className={this.state.flyingClass} fill="none" stroke="#86FCFF" strokeWidth="15" strokeLinecap="round" stroke-miterlimit="10" d={d.path} />
		// 			</g>
		// 		);
